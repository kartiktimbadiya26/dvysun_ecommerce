...
<main id="content" class="wrapper layout-page">
      <section class="position-relative" id="about_introduction">
            ...
            <div class="position-relative z-index-2 container py-18 py-lg-25">
                  ...
                  <h2 class="fs-56px mb-7">About Glowing</h2>
            </div>
      </section>
      <section>
            <div class="container pt-lg-17 pb-lg-20 pb-15 pt-11 mb-lg-4">
                  <div class="text-center pb-lg-17 pb-13 mb-3">
                        ...
                        <h3 class="mw-xl-50 mw-lg-60 mx-lg-auto mb-8">We strive to live with compassion, kindness and
                              empathy</h3>
                        <p class="mw-xl-60 mw-lg-75 mx-lg-auto mb-0">A lot of so-called stretch denim pants out there
                              are just glorified sweatpants – they get baggy and lose their shape. Not cool. Our tightly
                              knitted fabric holds its form after repeated wear. Plus, Aldays dress up or down, no prob.
                              So you can wear them all day. Get it?</p>
                  </div>
                  <div class="row mb-lg-18 mb-15 pb-3 align-items-center">
                        ...
                        <div class="col-lg-6 px-lg-12 ps-xl-18 pe-xl-20 mt-12 mt-lg-0">
                              ...
                              <p class="mb-0">Luxe, lightweight, and made with the perfect blend of cashmere and cotton,
                                    our Sonoma Pillows and Throws are inspired by the basics we turn to season after
                                    season. Get to know the cozy essentials that will elevate your space in an instant.
                              </p>
                        </div>
                  </div>
                        ...
                        <div class="col-lg-9 offset-lg-1 col-xl-8 offset-xl-2">
                              <div class="slick-slider main"
                                    ...
                                    <div class="text-center">
                                          <h4 class="mb-0">"Millions of combinations, meaning you get a totally unique
                                                piece of furniture exactly the way you want it."</h4>
                                    </div>
                                    <div class="text-center">
                                          <h4 class="mb-0">"Great tags, Millie has got used to it, nothing like the old
                                                tin tags of years gone by. Light weight and great colours available."
                                          </h4>
                                    </div>
                                    <div class="text-center">
                                          <h4 class="mb-0">"Amazing product. The results are so transformative in
                  ...
                  <div class="slick-slider mx-xl-n11"
                              ...
                              <div class="card border-0 hover-change-image ">
                                    <div class="position-relative overflow-hidden">
                                          <img class="card-img img-fluid lazy-image" src="#"
                                                data-src="./assets/images/others/our-team-01.jpg" width="377"
                                                height="446" alt="Slava Fedutik">
                                          <div
                        ...
                        <div class="px-xl-11">
                              <div class="card border-0 hover-change-image ">
                                    <div class="position-relative overflow-hidden">
                                          <img class="card-img img-fluid lazy-image" src="#"
                                                data-src="./assets/images/others/our-team-02.jpg" width="377"
                                                height="446" alt="Jennifer C.">
                                          <div
                                                class="card-img-overlay border-0 d-flex flex-column p-0 justify-content-end align-items-center">
                                                <ul
                                                      class="list-inline text-center bg-body-tertiary w-100 hover-image hover-bottom-to-top m-0 px-7 py-5">
                        ...
                        <div class="px-xl-11">
                              <div class="card border-0 hover-change-image ">
                                    <div class="position-relative overflow-hidden">
                                          <img class="card-img img-fluid lazy-image" src="#"
                                                data-src="./assets/images/others/our-team-03.jpg" width="377"
                                                height="446" alt="Valeriia Nadopta">
                                          <div
                                                class="card-img-overlay border-0 d-flex flex-column p-0 justify-content-end align-items-center">
                                                <ul
                                                      class="list-inline text-center bg-body-tertiary w-100 hover-image hover-bottom-to-top m-0 px-7 py-5">
